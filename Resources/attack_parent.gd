...
@export var hit_region := BattleAutoload.location_types.HIGH; # Region wherein this attack will strike
@export var gives_block := BattleAutoload.location_types.NONE; # Type of block the attack will give after finishing
