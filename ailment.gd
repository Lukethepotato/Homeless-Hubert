...
@export var force_attack: String = "" # will force the recipent to do this attack for the turn amount each turn unless its "" (note the animation name must be the same on both enemy and player)
