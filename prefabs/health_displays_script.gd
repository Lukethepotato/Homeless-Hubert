...
func _ready() -> void:
	...
	$enemy_info/enemy_healthbar.value = BattleAutoload.enemy_node.health;
	$enemy_info/enemy_healthbar.max_value = BattleAutoload.enemy_node.max_health;
...
func update_health() -> void:
	...
	$enemy_info/enemy_healthbar/number.text = "[center]" + str(BattleAutoload.enemy_node.health) + " / " + str(BattleAutoload.enemy_node.max_health)
	if tween:
		tween.kill();
	...
	tween.tween_property($enemy_info/enemy_healthbar, "value", BattleAutoload.enemy_node.health, 0.5);
